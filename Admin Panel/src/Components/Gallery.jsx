...
export default function Gallery(){
    ...
    const startEditCaption = (id) => {
        ...
        setFormData({
            ...
            orientation: imageToEdit.orientation
        });
        setEditingId(id);
        setShowForm(true);
    };
    ...
    // HANDLE EDITING
    const handleEdit = () => {
        axios.put(`/api/admin/edit/gallery/${editingId}`, { caption: formData.caption , orientation: formData.orientation})
            .then(() => {
                setGallery((prev) =>
                    prev.map((img) =>
                        img.id === editingId ? { ...img, caption: formData.caption } : img
                    )
                );
                setEditingId(null);
                setFormData({ caption: '' });
